...
vscode.commands.registerCommand('git.viewFileCommitDetails', (sha1, relativeFilePath, isoStrictDateTime) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const fileName = path_1.path.join(vscode.workspace.rootPath, relativeFilePath);
...
function run(fileName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const relativeFilePath = path_1.path.relative(gitRepositoryPath, fileName);
...
function diffFiles(fileName, sourceFile, sourceSha1, destinationFile, destinationSha1) {
    try {
        ...
        vscode.commands.executeCommand('vscode.diff', vscode.Uri.file(sourceFile), vscode.Uri.file(destinationFile), `${path_1.path.basename(fileName)} ${sourceFormattedSha1} ↔ ${path_1.path.basename(fileName)} ${destinationFormattedSha1}`);
    }
    catch (error) {
        logger.logError(error);
    }
...
function getFile(commitSha1, localFilePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            let ext = path_1.path.extname(localFilePath);
            return ext;
